...
const routes: Routes = [
  {
    ...
    children: [
...

      {
        path: 'comming',
        loadChildren: () =>
          import('./pages/comming/comming.module').then((m) => m.CommingModule),
      ...
      },
      {
        path: 'freelancers',
        loadChildren: () =>
          import('./pages/freelancers/freelancers.module').then(
      ...
      },
      {
        path: 'salons/:id/:name',
        loadChildren: () =>
          import('./pages/salons/salons.module').then((m) => m.SalonsModule),
        data: { title: 'Salons' },
      },
      {
        path: 'faq',
...

      {
        path: 'notice',
        loadChildren: () =>
          import('./pages/notice/notice.module').then((m) => m.NoticeModule),
        data: { title: 'Notice' },
      },
      {
        path: 'cookie',
        loadChildren: () =>
          import('./pages/cookie/cookie.module').then((m) => m.CookieModule),
        data: { title: 'Cookies' },
      },
      {
        path: 'blog',
      ...
      },
      {
        ...
        loadChildren: () =>
          import('./pages/service-listing/service-listing.module').then(
            (m) => m.ServiceListingModule
          ),
      ...
      },
      {
        ...
        loadChildren: () =>
          import('./pages/freelancer-checkout/freelancer-checkout.module').then(
            (m) => m.FreelancerCheckoutModule
          ),
      ...
      },
      {
        ...
        loadChildren: () =>
          import('./pages/product-checkout/product-checkout.module').then(
      ...
      },
      {
        path: 'await-payments',
        loadChildren: () =>
          import('./pages/await-payments/await-payments.module').then(
            (m) => m.AwaitPaymentsModule
          ),
      ...
      },
      {
        ...
        loadChildren: () =>
          import(
            './pages/await-payments-product/await-payments-product.module'
          ).then((m) => m.AwaitPaymentsProductModule),
        data: { title: 'Await Payments' },
        canDeactivate: [LeaveGuard],
      },
      {
      ...
      },
      {
        ...
        loadChildren: () =>
          import('./pages/top-freelancers/top-freelancers.module').then(
            (m) => m.TopFreelancersModule
          ),
        data: { title: 'Top Freelancers' },
      },
      {
      ...
      },
      {
        path: 'supports',
        loadChildren: () =>
          import('./pages/supports/supports.module').then(
            (m) => m.SupportsModule
          ),
      },
    ],
  },
  {
    path: 'costumer-login',
    loadChildren: () =>
      import('./pages/costumer-login/costumer-login.module').then(
        (m) => m.CostumerLoginModule
      ),
  },
  {
    path: 'costumer-register',
    loadChildren: () =>
      import('./pages/costumer-register/costumer-register.module').then(
        (m) => m.CostumerRegisterModule
      ),
  },
  {
    path: '**',
